...
#include "openbot_slam/stereo.hpp"

namespace openbot_ros {

Stereo::Stereo(ORB_SLAM3::System* pSLAM, const string &strSettingsFile, const string &strDoRectify)
:   Node("stereo_node"),
    m_SLAM(pSLAM)
{
    ...
    syncApproximate->registerCallback(&Stereo::GrabStereo, this);
}
...
void Stereo::GrabStereo(const ImageMsg::SharedPtr msgLeft, const ImageMsg::SharedPtr msgRight)
{
