...
NodeOptions CreateNodeOptions(::openbot::common::LuaParameterDictionary* const lua_parameter_dictionary) 
{
  NodeOptions options;
...
//   auto file_resolver =
//       absl::make_unique<openbot::common::ConfigurationFileResolver>(
//           std::vector<std::string>{configuration_directory});
//   const std::string code =
//       file_resolver->GetFileContentOrDie(configuration_basename);
//   openbot::common::LuaParameterDictionary lua_parameter_dictionary(
