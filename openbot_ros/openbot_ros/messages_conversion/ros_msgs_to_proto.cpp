...
{
    ::openbot_bridge::ros2_msgs::builtin_interfaces::Time proto;
...
{
    ::openbot_bridge::ros2_msgs::std_msgs::Header proto;
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::Accel proto;
    *proto.mutable_linear() = ToProto(ros.linear);
    *proto.mutable_angular() = ToProto(ros.angular);
    return proto;
}

::openbot_bridge::ros2_msgs::geometry_msgs::AccelStamped ToProto(
    const geometry_msgs::msg::AccelStamped& ros)
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::AccelStamped proto;
    *proto.mutable_header() = ToProto(ros.header);
    *proto.mutable_accel() = ToProto(ros.accel);
    return proto;
}

::openbot_bridge::ros2_msgs::geometry_msgs::AccelWithCovariance ToProto(
    const geometry_msgs::msg::AccelWithCovariance& ros)
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::AccelWithCovariance proto;
    *proto.mutable_accel() = ToProto(ros.accel);
...
::openbot_bridge::ros2_msgs::geometry_msgs::AccelWithCovarianceStamped ToProto(
    const geometry_msgs::msg::AccelWithCovarianceStamped& ros)
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::AccelWithCovarianceStamped proto;
    *proto.mutable_header() = ToProto(ros.header);
    *proto.mutable_accel() = ToProto(ros.accel);
    return proto;
}
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::Point proto;
    proto.set_x(ros.x);
    proto.set_y(ros.y);
    proto.set_z(ros.z);
    return proto;
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::Point32 proto;
    proto.set_x(ros.x);
    proto.set_y(ros.y);
    proto.set_z(ros.z);
    return proto;
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::PointStamped proto;
    *proto.mutable_header() = ToProto(ros.header);
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::Polygon proto;
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::PolygonStamped proto;
    *proto.mutable_header() = ToProto(ros.header);
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::Pose proto;
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::Pose2D proto;
    proto.set_x(ros.x);
    proto.set_y(ros.y);
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::PoseArray proto;
    *proto.mutable_header() = ToProto(ros.header);
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::PoseStamped proto;
    *proto.mutable_header() = ToProto(ros.header);
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::PoseWithCovariance proto;
    *proto.mutable_pose() = ToProto(ros.pose);
    for (int i = 0; i < ros.covariance.size(); ++i) {
        proto.set_covariance(i, ros.covariance[i]);
    }
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::PoseWithCovarianceStamped proto;
    *proto.mutable_header() = ToProto(ros.header);
    *proto.mutable_pose() = ToProto(ros.pose);
    return proto;
}
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::Quaternion proto;
    proto.set_x(ros.x);
    proto.set_y(ros.y);
    proto.set_z(ros.z);
    proto.set_w(ros.w);
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::QuaternionStamped proto;
    *proto.mutable_header() = ToProto(ros.header);
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::Transform proto;
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::TransformStamped proto;
    *proto.mutable_header() = ToProto(ros.header);
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::Twist proto;
    *proto.mutable_linear() = ToProto(ros.linear);
    *proto.mutable_angular() = ToProto(ros.angular);
    return proto;
}
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::TwistStamped proto;
    *proto.mutable_header() = ToProto(ros.header);
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::TwistWithCovariance proto;
    *proto.mutable_twist() = ToProto(ros.twist);
    for (int i = 0; i < ros.covariance.size(); ++i) {
        proto.set_covariance(i, ros.covariance[i]);
    }
...
::openbot_bridge::ros2_msgs::geometry_msgs::TwistWithCovarianceStamped ToProto(
    const geometry_msgs::msg::TwistWithCovarianceStamped& ros)
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::TwistWithCovarianceStamped proto;
    *proto.mutable_header() = ToProto(ros.header);
    *proto.mutable_twist() = ToProto(ros.twist);
    return proto;
}
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::Vector3 proto;
    proto.set_x(ros.x);
    proto.set_y(ros.y);
    proto.set_z(ros.z);
    return proto;
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::Vector3Stamped proto;
    *proto.mutable_header() = ToProto(ros.header);
...
{
    ::openbot_bridge::ros2_msgs::geometry_msgs::VelocityStamped proto;
    *proto.mutable_header() = ToProto(ros.header);
...
{
    ::openbot_bridge::ros2_msgs::nav_msgs::GridCells proto;
    *proto.mutable_header() = ToProto(ros.header);
...
{
    ::openbot_bridge::ros2_msgs::nav_msgs::MapMetaData proto;
...
{
    ::openbot_bridge::ros2_msgs::nav_msgs::OccupancyGrid proto;
    *proto.mutable_header() = ToProto(ros.header);
...
{
    ::openbot_bridge::ros2_msgs::nav_msgs::Odometry proto;
    *proto.mutable_header() = ToProto(ros.header);
    proto.set_child_frame_id(ros.child_frame_id);
    *proto.mutable_pose() = ToProto(ros.pose);
    *proto.mutable_twist() = ToProto(ros.twist);
...
{
    ::openbot_bridge::ros2_msgs::nav_msgs::Path proto;
    *proto.mutable_header() = ToProto(ros.header);
    for (int i = 0; i < ros.poses.size(); ++i) {
        *proto.mutable_poses(i) = ToProto(ros.poses[i]);
    }
...
{
    ::openbot_bridge::ros2_msgs::sensor_msgs::CameraInfo proto;
    *proto.mutable_header() = ToProto(ros.header);
    proto.set_width(ros.width);
    proto.set_height(ros.height);
...
{
    ::openbot_bridge::ros2_msgs::sensor_msgs::ChannelFloat32 proto;
...
{
    ::openbot_bridge::ros2_msgs::sensor_msgs::CompressedImage proto;
    *proto.mutable_header() = ToProto(ros.header);
...
{
    ::openbot_bridge::ros2_msgs::sensor_msgs::Illuminance proto;
    *proto.mutable_header() = ToProto(ros.header);
...
{
    ::openbot_bridge::ros2_msgs::sensor_msgs::Image proto;
    *proto.mutable_header() = ToProto(ros.header);
    proto.set_width(ros.width);
    proto.set_height(ros.height);
...
{
    ::openbot_bridge::ros2_msgs::sensor_msgs::Imu proto;
    *proto.mutable_header() = ToProto(ros.header);
    *proto.mutable_orientation() = ToProto(ros.orientation);
...
{
    ::openbot_bridge::ros2_msgs::sensor_msgs::LaserScan proto;
    *proto.mutable_header() = ToProto(ros.header);
...
{
    ::openbot_bridge::ros2_msgs::sensor_msgs::PointCloud proto;
    *proto.mutable_header() = ToProto(ros.header);
    for (int i = 0; i < ros.points.size(); ++i) {
        *proto.mutable_points(i) = ToProto(ros.points[i]);
    }
...
{
    ::openbot_bridge::ros2_msgs::sensor_msgs::PointCloud2 proto;
    *proto.mutable_header() = ToProto(ros.header);
    proto.set_width(ros.width);
    proto.set_height(ros.height);
...
{
    ::openbot_bridge::ros2_msgs::sensor_msgs::PointField proto;
    proto.set_name(ros.name);
...
{
    ::openbot_bridge::ros2_msgs::sensor_msgs::Range proto;
    *proto.mutable_header() = ToProto(ros.header);
...
{
    ::openbot_bridge::ros2_msgs::sensor_msgs::RegionOfInterest proto;
...
{
    ::openbot_bridge::ros2_msgs::shape_msgs::Mesh proto;
...
{
    ::openbot_bridge::ros2_msgs::shape_msgs::MeshTriangle proto;
...
{
    ::openbot_bridge::ros2_msgs::shape_msgs::Plane proto;
...
{
    ::openbot_bridge::ros2_msgs::shape_msgs::SolidPrimitive proto;
