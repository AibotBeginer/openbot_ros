...
#ifndef OPENBOT_ROS_OPENBOT_ROS_ROS_LOG_SINK_HPP
#define OPENBOT_ROS_OPENBOT_ROS_ROS_LOG_SINK_HPP
...
class ScopedRosLogSink : public ::google::LogSink {
 ...
 private:
  bool will_die_;
  rclcpp::Logger logger_{rclcpp::get_logger("openbot logger")};
};

}  // namespace openbot_ros

#endif  // OPENBOT_ROS_OPENBOT_ROS_ROS_LOG_SINK_HPP
