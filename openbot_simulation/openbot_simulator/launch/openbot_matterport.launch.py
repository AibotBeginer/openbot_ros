...
def generate_launch_description():
    ...
    world = os.path.join(
        ...
        'worlds',
        'openbot_matterport.world'
    )

    declare_arg_world = DeclareLaunchArgument(
        'base_world', default_value='openbot_matterport.world',
    ...
    declare_ignore_models = DeclareLaunchArgument(
        'ignore_models', default_value='ground_plane openbot_matterport',
    ...
    spawn_openbot_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
    ...
    ld.add_action(spawn_openbot_cmd)
    return ld
